  ...
  return (
    <div className="app-layout">
      ...
      <div className="synthwave-bg" aria-hidden="true">
        <div className="sw-mountains" />
        <div className="sw-sun" />
        <div className="sw-sun-lines" />
        <div className="sw-grid" />
        <div className="sw-fog" />
      </div>
      ...
      <aside className="sidebar">
        ...
        <nav className="sidebar-nav">
          ...
          <button className={`nav-item ${location.pathname === '/tasks' ? 'active' : ''}`} onClick={() => navigate('/tasks')}>
            <span className="nav-icon">◻</span>
            <span>Tareas</span>
          </button>
          <button className={`nav-item ${location.pathname === '/habits' ? 'active' : ''}`} onClick={() => navigate('/habits')}>
            <span className="nav-icon">◈</span>
            <span>Hábitos</span>
          </button>
        </nav>
